...
const CONTENT = {
  mentions: {
    ...
    sections: [
      ...
      { heading: '4. Responsabilité', text: "Zahowa s'efforce d'assurer l'exactitude des informations diffusées. Le site propose un accès anticipé à un produit en phase de finalisation. Les descriptions sont indicatives et sujettes à évolution." },
  ...
  confidentialite: {
    ...
    sections: [
      ...
      { heading: '2. Données collectées', text: "Uniquement les données transmises via le formulaire :\n• Adresse email\n• Réponses au questionnaire (âge, genre, habitudes café, profil aromatique)\n\nAucun cookie publicitaire." },
      { heading: '3. Finalités', text: "• Vous informer du lancement\n• Vous donner accès au Cercle Fondateur\n• Affiner les recettes\n\nBase légale : consentement (art. 6.1.a RGPD)." },
      { heading: '4. Destinataires', text: "Données stockées chez Brevo (sous-traitant RGPD). Aucune vente à des tiers." },
      { heading: '5. Durée de conservation', text: "Jusqu'à désinscription. Suppression sous 30 jours." },
      { heading: '6. Vos droits', text: "Accès, rectification, effacement, portabilité, opposition.\nContact : contact@zahowa.com\nRéclamation possible auprès de la CNIL." },
