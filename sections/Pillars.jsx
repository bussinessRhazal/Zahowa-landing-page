...
const ICONS = {
  ...
  leaf: (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M18 30 C18 30 6 24 6 14 C6 8 12 5 18 5 C24 5 30 8 30 14 C30 24 18 30 18 30Z" />
      <path d="M18 30 L18 18" />
      <path d="M18 22 C18 22 12 18 10 14" />
      <path d="M18 18 C18 18 24 16 27 12" />
    </svg>
  ),
  precision: (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section className="pillars" id="pillars">
      <div className="container">
        ...
        <div className="pillars__grid pillars__grid--4">
          {PILLARS.map((pillar) => (
